        ...
        <section class="parent page-body">
            <div class="grid-8 grid-smalltablet-12 no-gutter-left no-gutter-smalltablet">
                <div class="bg-blanco">
                    ...
                    <form class="filters-form regular-form" method="get" action="<?php echo get_term_link( $current_term ); ?>" >
                    ...
                    <div class="archive-box">
                        ...
                        <?php 
                            ...
                            if( !!$sede_filtro ){
                                $tax_query = merge_tax_query( $tax_query, array(
                                    'taxonomy' => 'sede',
                                    'field' => 'term_id',
                                    'terms' => $sede_filtro
                                ));
                            ...
                            echo get_eventos(array(), true, true);
                        ?>
                    </div>
                </div>
            </div>
